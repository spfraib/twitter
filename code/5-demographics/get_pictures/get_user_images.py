...
output_dir = "/scratch/spf248/twitter/data/classification/US/profile_pictures_sam/" +str(SLURM_ARRAY_TASK_ID)
...
print('Load')
start = timer()
dir_name = "/scratch/spf248/twitter/data/classification/US/users/"
#filenames = os.listdir("/scratch/spf248/twitter/data/classification/US/users/")
paths_to_filtered=list(np.array_split(glob(os.path.join(dir_name,'*.parquet')),SLURM_ARRAY_TASK_COUNT)[SLURM_ARRAY_TASK_ID])
