...
PREPROCESSED='0'
PARQUET_PATH='twitter/code/2-twitter_labor/model_training/saved_data'
...
python3 twitter/code/2-twitter_labor/model_training/further_finetuning/further_finetuning.py \
