...
if not os.path.exists('../mturk_mar6/log_{}/'):
    os.makedirs('../mturk_mar6/log_{}/')

if not os.path.exists('../mturk_mar6/output_{}'):
    os.makedirs('../mturk_mar6/output_{}')

LOG_PATH = Path('../mturk_mar6/log_{}/')
DATA_PATH = Path('../mturk_mar6/data_multilabel/')
LABEL_PATH = Path('../mturk_mar6/data_multilabel/')
OUTPUT_PATH = Path('../mturk_mar6/output_{}')
FINETUNED_PATH = None
