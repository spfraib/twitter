...
process_inference_output_spark.py \
--inference_output_folder /user/mt4493/twitter/inference/${INFERENCE_FOLDER} \
--random_chunks_with_operations_folder /scratch/mt4493/twitter_labor/twitter-labor-data/data/random_chunks_with_operations
