...
if __name__ == "__main__":
    ...
    path_to_tweets = f'/user/spf248/twitter/data/timelines/random_samples/{args.country_code}/'
    ...
    path_to_df_new_samples = f'/user/spf248/twitter/data/timelines/random_samples/random_samples_splitted/{args.country_code}/new_samples'
    path_to_df_evaluation = f'/user/spf248/twitter/data/timelines/random_samples/random_samples_splitted/{args.country_code}/evaluation'
