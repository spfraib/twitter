...
if __name__ == "__main__":
    df = spark.read.parquet('/user/mt4493/twitter/ngram_samples/US/samples')
    ...
    df_sampled.coalesce(1).write.csv('/user/mt4493/twitter/ngram_samples/US/specificity_check')
