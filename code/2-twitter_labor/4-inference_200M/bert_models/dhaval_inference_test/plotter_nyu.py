...
data_folder_path = '/Users/dval/work_temp/twitter_from_nyu/nyu_results'
...
for file in os.listdir(data_folder_path+'/is_unemployed/'):
...
ggsave(file='**_gpu.png', width = 5, height = 5, dpi = 300)
'''
