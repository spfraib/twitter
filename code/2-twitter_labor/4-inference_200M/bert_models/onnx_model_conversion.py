...
if args.method == 0:
    best_model_paths_dict = {
        'US': {
            ...
            'iter5': {
                'lost_job_1mo': 'DeepPavlov-bert-base-cased-conversational_may12_iter5_6744234_seed-14',
                'is_hired_1mo': 'DeepPavlov-bert-base-cased-conversational_may12_iter5_6744231_seed-11',
                'is_unemployed': 'DeepPavlov-bert-base-cased-conversational_may12_iter5_6744222_seed-2',
                'job_offer': 'DeepPavlov-bert-base-cased-conversational_may12_iter5_6744225_seed-5',
                'job_search': 'DeepPavlov-bert-base-cased-conversational_may12_iter5_6744230_seed-10'
            },
        },
        'BR': {
            'iter0': {
        ...
        'MX': {
            ...
            'iter6': {
                'lost_job_1mo': 'dccuchile-bert-base-spanish-wwm-cased_may24_iter6_7100993_seed-14',
                'is_hired_1mo': 'dccuchile-bert-base-spanish-wwm-cased_may24_iter6_7100986_seed-7',
                'is_unemployed': 'dccuchile-bert-base-spanish-wwm-cased_may24_iter6_7100985_seed-6',
                'job_offer': 'dccuchile-bert-base-spanish-wwm-cased_may24_iter6_7100992_seed-13',
                'job_search': 'dccuchile-bert-base-spanish-wwm-cased_may24_iter6_7100990_seed-11'
            },
        }
    }
elif args.method == 1:
