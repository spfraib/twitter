...
for column in ["is_unemployed", "lost_job_1mo", "job_search", "is_hired_1mo", "job_offer"]:
    ...
    if not os.path.exists(os.path.join(root_path,'iteration1/inferences_dhaval', column)):
        print('>>>> directory doesnt exists, creating it')
        os.makedirs(os.path.join(root_path,'iteration1/inferences_dhaval', column))   
    ...
    predictions_random_df.to_csv(
        os.path.join(root_path,'iteration1/inferences_dhaval', column, 'random'+'-'+str(SLURM_ARRAY_TASK_ID)+'.csv')
        # os.path.join(root_path,'iteration1/inferences', column, 'random'+'-'+str(SLURM_JOB_ID)+'-'+str(SLURM_ARRAY_TASK_ID)+'.csv')
        )
    print('saved to:\n', os.path.join(root_path,'iteration1/inferences_dhaval', column, 'random'+'-'+str(SLURM_ARRAY_TASK_ID)+'.csv'), 'saved')
