...
#     loop_start = time.time()
    ...
    predictions_random_df.to_csv(
        os.path.join(root_path,'pred_output_100M_GLOVE_CNN_optimized', column, 'random'+'-'+str(SLURM_JOB_ID)+'-'+str(SLURM_ARRAY_TASK_ID)+'.csv')
        )
    print('saved to:\n', os.path.join(root_path,'pred_output_100M_GLOVE_CNN_optimized', column, 'random'+'-'+str(SLURM_JOB_ID)+'-'+str(SLURM_ARRAY_TASK_ID)+'.csv'), 'saved')
