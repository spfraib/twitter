...
if not os.path.exists('../mturk_mar6/output_binary_pos_neg_balanced_{}'.format(column)):
    os.makedirs('../mturk_mar6/output_binary_pos_neg_balanced_{}'.format(column))
...
OUTPUT_PATH = Path('../mturk_mar6/output_binary_pos_neg_balanced_{}'.format(column))
FINETUNED_PATH = None
